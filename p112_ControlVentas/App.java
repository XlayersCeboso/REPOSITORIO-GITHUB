...
public class App {
    public static void main(String[] args) {
        ...
        mitienda.agregarCliente(new Cliente("Andres Lopez", "Palacio Nacional", "peje@yahoo.com"));
        mitienda.agregarCliente(new Cliente("Xochitl Gelatinas", "Danone 123", "xochutl@precidencia.gob.mx"));
